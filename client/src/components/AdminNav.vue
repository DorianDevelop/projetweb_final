<template>
    <div class="admin_nav"> 
        <nav>
            <router-link to="/admin" class="admin_dashboard_link">
                <i class="fa-solid fa-gear"></i> 
            </router-link>
            <div class="mid_pack">
                <router-link to="/admin/users/index" class="nav_btn account_btn">
                    <i class="fa-solid fa-user"></i>
                </router-link>
                <router-link to="/" class="admin_home_btn">
                    <div class="site_icon">
                ...
                <router-link to="/admin/articles/index" class="nav_btn post_btn">
                    <i class="fa-solid fa-file"></i>
                </router-link>
            </div>
            <div class="admin_logout_btn" @click="logout">
...
.nav_btn:active{
    background:var(--darker-first_color);
}

.mid_pack .router-link-exact-active{
...
.admin_dashboard_link:active,
.admin_logout_btn:active{
    color: var(--darker-first_color);
}
</style>